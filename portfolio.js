...
export const skillsSection = {
	...
	subTitle: (
		<>
			A Full Stack Developer weaving digital worlds from server to sensor,{" "}
			<br />
	...
	data: [
		{
			...
			description:
				"From edge to cloud: crafting intelligent, connected systems.",
		...
		},
		{
			...
			description:
				"From frontend polish to backend power — full-stack excellence.",
		...
		},
		{
			...
			description:
				"From code to cloud: build, ship, and scale with confidence.",
		...
		},
		{
			title: "Blockchain",
			description:
				"Smart contracts and decentralized logic at your fingertips.",
